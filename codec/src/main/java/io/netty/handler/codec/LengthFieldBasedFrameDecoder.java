...
public class LengthFieldBasedFrameDecoder extends ByteToMessageDecoder {
     ...
     * @return frame           the {@link ByteBuf} which represent the frame or {@code null} if no
     * frame could
     * be created.
     */
    ...
    /**
     * Decodes the specified region of the buffer into an unadjusted frame length.  The default
     * implementation is
     * capable of decoding the specified region into an unsigned 8/16/24/32/64 bit integer.
     * Override this method to
     * decode the length field encoded differently.  Note that this method must not modify the state
     * of the specified
